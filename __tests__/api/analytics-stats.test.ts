...
describe('/api/analytics/stats rate limiting', () => {
    ...
    const mockCapsules = [
        {
            ...
            aiReflection: 'This is a positive reflection',
        },
        {
        ...
        },
        {
            ...
            aiReflection: 'Another positive insight',
        },
    ]
    ...
    describe('Rate limit enforcement', () => {
        it('should allow requests within rate limit', async () => {
            ...
            expect(data.data.totalMemories).toBe(3)
            expect(data.data.emotionalScore).toBeGreaterThan(0)
            expect(data.data.aiInsights).toBe(2)
    ...
    describe('Analytics functionality', () => {
        it('should calculate emotional score correctly', async () => {
            mockPrisma.rateLimit.findUnique.mockResolvedValue({
                id: 'rate_limit_123',
                userId: mockUser.id,
                endpoint: '/api/analytics',
            ...
            expect(response.status).toBe(200)
            expect(data.data.emotionalScore).toBeGreaterThan(0)
            expect(data.data.emotionalScore).toBeLessThanOrEqual(10)
        })
        ...
        it('should handle empty capsule data', async () => {
            ...
            expect(data.data.emotionalScore).toBe(5) // Default score
