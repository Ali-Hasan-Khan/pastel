  ...
  useEffect(() => {
    ...
    function generateColor(): ColorRGB {
      ...
      const lightThemeColors = [
        { r: 0.33, g: 0.27, b: 0.40 }, //rgb(53, 45, 62) - dark purple
        { r: 0.33, g: 0.27, b: 0.40 }, //rgb(68, 55, 83) - very dark purple
      ];

      // Dark theme - use lighter, pastel colors
      const darkThemeColors = [
        { r: 0.76, g: 0.59, b: 0.86 }, // #c4a9db - main purple
        { r: 0.62, g: 0.50, b: 0.75 }, // #9f7fc0 - darker purple
        { r: 0.70, g: 0.59, b: 0.81 }, // #b397d0 - medium purple
        { r: 0.85, g: 0.77, b: 0.94 }, // #d8c5f0 - light purple
        { r: 0.64, g: 0.85, b: 0.75 }, // #a2d8c0 - mint green
        { r: 0.91, g: 0.84, b: 0.94 }, // #e9d5f0 - very light purple
        { r: 0.66, g: 0.60, b: 0.73 }, // #a99bc1 - muted purple
        { r: 0.48, g: 0.71, b: 0.63 }, // #7ab5a0 - sage green
        { r: 0.94, g: 0.91, b: 0.97 }, // #f0e8f7 - almost white purple
        { r: 0.58, g: 0.52, b: 0.65 }, // #9485a6 - medium muted purple
      ];

      // Choose color palette based on theme
      const isLightTheme = theme === 'light';
      const colorPalette = isLightTheme ? lightThemeColors : darkThemeColors;

      // Randomly select a base color from the appropriate palette
      const baseColor = colorPalette[Math.floor(Math.random() * colorPalette.length)];
      
      // Add slight variation to the selected color for more natural feel
      const variation = 0.08; // Slightly reduced variation for more consistent colors
      ...
      const intensity = isLightTheme ? 0.4 : 0.3; // Slightly higher intensity for dark colors in light theme
